dep "papertrail config" do
  ...
  def papertrail_config_src
    "papertrail/papertrail.conf"
  end

  def papertrail_config_dest
...
dep "papertrail cert" do
  def papertrail_cert_src
    "papertrail/papertrail-bundle.pem"
  end

  def papertrail_cert_dest
